...
📌 Visuals Included
VisualDescriptionKPI CardsTotal Sales, Region-wise ProfitBar ChartSales by CategoryBar ChartProfit by CategoryPie ChartSales by RegionLine ChartSales Trend Over TimeSlicerOrder Date filter

🛠️ Tools Used

Power BI Desktop — dashboard design & visualization
DAX — custom measures and calculations
Dataset — Sample Superstore (built-in Power BI dataset)
